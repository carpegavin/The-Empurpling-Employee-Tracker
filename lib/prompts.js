    ...
    try {
        answer = await inquirer
            .prompt([
                ...
                choices: roles.map(role => role.title) // Gavin, let's use map function to only show role_title
                },
                {
                name: "managerName",
                type: "rawlist",
                message: "Who is the employee's manager?",
                choices: managers.map(manager => manager.name) // Gavin, let's map function to only show manager_name
                }
